...
#define MKTYPE2_I(NAME) pyed##_##NAME##_specials(); if (!to_ok(&pyed##_##NAME##_Type)) return NULL;
#else
#define MKTYPE2(NAME) MKTYPE2_I(NAME)
#define MKTYPE2_I(NAME) pyed##_##NAME##_specials(); if (!to_ok(&pyed##_##NAME##_Type)) return
#endif
...
#include QUOTEME(build/pyed_generated_include.h)
...
#define PYOPENCV_TO  pyed_to
#define PYOPENCV_FROM  pyed_from
...
#include QUOTEME(build/pyed_generated_types.h)

#include QUOTEME(build/pyed_generated_funcs.h)
...
#include QUOTEME(build/pyed_generated_ns_reg.h)
...
#include QUOTEME(build/pyed_generated_type_reg.h)
...
#include QUOTEME(build/pyed_generated_type_publish.h)
